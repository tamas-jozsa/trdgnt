...
def run_daily_cycle(tickers, amount, dry_run, stop_loss, trading_client, data_client, parallel: int = 1):
...
def main():
    ...
    while True:
        ...
        run_daily_cycle(tickers, args.amount, args.dry_run, args.stop_loss, trading_client, data_client, parallel=parallel_workers)
