...
def create_market_analyst(llm):
    ...
    def market_analyst_node(state):
        ...
        system_message = (
            ...
            f"2. Call get_indicators with these 8 indicators: "
            f"close_50_sma, close_200_sma, close_10_ema, macd, macds, rsi, atr, vwma\n"
            ...
            f"- ATR value — use this to suggest a stop-loss distance\n"
