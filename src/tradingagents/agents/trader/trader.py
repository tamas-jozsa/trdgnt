        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    f"4. Target: YOUR OWN 30-day price estimate — anchor to a technical level "
                    f"(resistance, 50-day SMA, Bollinger upper) reachable in 30 days. "
                    f"Do NOT use the Wall St analyst consensus target. "
                    f"Realistic range: 5-20% from current price unless an earnings catalyst is within 30 days.\n"
